...
namespace UsefulWeb\TbMultiSelect;
...
class TbMultiSelect extends CInputWidget
{
  ...
  {
    $baseDir = Yii::getPathOfAlias('application.vendor.bower.bootstrap-multiselect');
    $assets = Yii::app()->getAssetManager()->publish($baseDir.DIRECTORY_SEPARATOR.'dist');
